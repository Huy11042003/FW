...
/* Example application name and version to display on LCD screen. TAG DELAY ��ཻ������ӳ�ʱ�� */
#define RNG_DELAY_MS 5
	
/* Default antenna delay values for 64 MHz PRF. See NOTE 1 below. �����ӳ�ʱ�� */
...
static uint8 rx_poll_msg[] =  {0x41, 0x88, 0, 0x0, 0xDE, 'W', 'A', 'V', 'E', 0x21, 0, 0};//author�յ�����Ϣ��ı�׼��ʽ
static uint8 tx_resp_msg[] =  {0x41, 0x88, 0, 0x0, 0xDE, 'V', 'E', 'W', 'A', 0x10, 0x02, 0, 0, 0, 0};////author���͵���Ϣ��ı�׼��ʽ
...
//#define ANTHOR
#define ANCHOR_MAX_NUM 45//3 Ĭ��������վ
//uint8_t ANCHOR_IND=0 ;  // 0 1 2 ��վID
